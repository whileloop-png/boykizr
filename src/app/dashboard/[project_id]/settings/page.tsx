        ...
        <TabsContent value="advanced" className="*:mb-5 *:mt-5">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set a github repo so guard can fetch the script file</CardDescription>
            </CardHeader>
            <CardFooter className="flex flex-col">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set a github access token so guard can fetch the script file</CardDescription>
            </CardHeader>
            <CardFooter className="flex flex-col">
